...
function DetailModal({
  ...
  const getStatusStyle = (status: string) => {
    switch (status) {
      case 'pending': return 'bg-transparent text-white border-white/50';
      case 'processing': return 'bg-transparent text-white border-white/50';
      case 'resolved': return 'bg-transparent text-white border-white/50';
      case 'rejected': return 'bg-transparent text-white/60 border-white/20';
      default: return 'bg-transparent text-white/60 border-white/20';
    }
  };
            ...
            <div className="flex items-center gap-2">
              {adminInfo.isOwner && (
                <button
                  ...
                  className="text-white/60 hover:text-white hover:bg-white/10 text-sm px-3 py-1.5 rounded-lg transition-all flex items-center gap-1"
                >
                   删除
                </button>
              )}
          ...
          {complaint.evidence && (
            <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 p-4 rounded-xl border border-cyan-500/30">
              ...
              <a 
                ...
                className="text-white/60 hover:text-white underline break-all text-sm flex items-center gap-1"
              >
                点击查看证据链接 <span>↗</span>
              </a>
            </div>
    ...
    <div className="min-h-screen">
      <div className="mb-6">
        <div className="flex items-center gap-4 mb-2">
          <div className="w-12 h-12 rounded-xl flex items-center justify-center text-2xl shadow-lg" style={{border: '1px solid rgba(138, 158, 255, 0.9)', backgroundColor: 'rgba(138, 158, 255, 0.8)'}}>
          ...
          <div>
            ...
            <p className="text-white/60 text-sm">共 {stats.total} 条投诉记录</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
        <div 
          ...
          className={`p-4 rounded-xl cursor-pointer transition-all hover:scale-105 ${filter === 'all' ? '' : ''}`}
      ...
      <div className="flex items-center gap-4 mb-6">
        <div className="relative flex-1 max-w-md">
          <input
            ...
            className="w-full rounded-xl pl-10 pr-4 py-2.5 text-white placeholder-white/40 focus:outline-none transition-all text-sm"
        ...
        <select
          ...
          className="rounded-xl px-4 py-2.5 text-white focus:outline-none transition-all text-sm"
          style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}
        >
