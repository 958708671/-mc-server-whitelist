...
export default function EventsPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'ended':
        return <span className="px-2 py-1 text-white/60 rounded text-xs" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.3)'}}>已结束</span>;
      case 'cancelled':
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-white/60 text-sm mt-1">创建和管理服务器活动</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="rounded-xl p-12 text-center" style={{border: '1px solid rgba(30, 40, 60, 0.7)', backgroundColor: 'rgba(30, 40, 60, 0.8)'}}>
          ...
          <p className="text-white/60 text-lg">暂无活动</p>
        </div>
      ) : (
          ...
          <table className="w-full">
            <thead className="bg-transparent">
              <tr>
                ...
                <th className="text-left px-4 py-3 text-white/60 font-medium">开始时间</th>
                <th className="text-left px-4 py-3 text-white/60 font-medium">结束时间</th>
      ...
      {showEditor && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="rounded-2xl p-6 w-full max-w-2xl shadow-2xl max-h-[90vh] overflow-y-auto" style={{border: '1px solid rgba(30, 40, 60, 0.7)', backgroundColor: 'rgba(30, 40, 60, 0.95)'}}>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="输入活动标题"
                  className="w-full rounded-xl px-4 py-3 text-white focus:outline-none" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full bg-transparent border border-white/20 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-white/50 resize-none"
                />
              </div>
