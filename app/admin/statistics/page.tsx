...
export default function StatisticsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {overview && (
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
            <div className="rounded-xl p-5" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
              ...
              <div className="text-white/60 text-sm mt-1">总人数</div>
            </div>
            ...
            <div className="rounded-xl p-5" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
              ...
              <div className="text-white/60 text-sm mt-1">白名单申请</div>
            </div>
            ...
            <div className="rounded-xl p-5" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
              ...
              <div className="text-white/60 text-sm mt-1">总投诉数</div>
            </div>
            ...
            <div className="rounded-xl p-5" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
              ...
              <div className="text-white/60 text-sm mt-1">封禁人数</div>
            </div>
            ...
            <div className="rounded-xl p-5" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
              ...
              <div className="text-white/60 text-sm mt-1">投诉</div>
            </div>
            ...
            <div className="rounded-xl p-5" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
              ...
              <div className="text-white/60 text-sm mt-1">黑名单</div>
            </div>
            ...
            <div className="rounded-xl p-5" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
              ...
              <div className="text-white/60 text-sm mt-1">总条数</div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-xl p-5" style={{border: '1px solid rgba(30, 40, 60, 0.7)', backgroundColor: 'rgba(30, 40, 60, 0.8)'}}>
              <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
                 本周数据
              </h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-white/60">新增白名单</span>
                  <span className="text-white font-bold">{overview.whitelist.new_whitelist_week}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-white/60">待处理投诉</span>
                  <span className="text-white font-bold">{overview.complaints.pending_complaints}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-white/60">已解决投诉</span>
            ...
            <div className="rounded-xl p-5" style={{border: '1px solid rgba(30, 40, 60, 0.7)', backgroundColor: 'rgba(30, 40, 60, 0.8)'}}>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-white/60">白名单通过率</span>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-white/60">投诉解决率</span>
                  <span className="text-white font-bold">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-white/60">封禁比例</span>
                  <span className="text-white font-bold">
        ...
        <div className="rounded-xl p-5" style={{border: '1px solid rgba(30, 40, 60, 0.7)', backgroundColor: 'rgba(30, 40, 60, 0.8)'}}>
          ...
          <div className="space-y-3">
            {rankings.map((admin, index) => (
              <div 
                key={admin.id}
                className="flex items-center justify-between p-3 rounded-lg" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}
              >
                ...
                <div className="flex items-center gap-6 text-sm">
                  <span className="text-white/60">白名单: {admin.whitelist_reviews}</span>
                  <span className="text-white/60">投诉: {admin.complaint_handles}</span>
                  <span className="text-white font-bold">
      ...
      {/* 日历组件 */}
      <div className="bg-transparent rounded-xl p-5 border border-white/20">
        <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
           活动和公告日历
        </h3>
        <div className="flex items-center justify-between mb-4">
          <button 
            ...
            className="px-3 py-1 text-white rounded-lg transition-all" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'rgba(93, 122, 156, 1)'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'rgba(93, 122, 156, 0.8)'}
          >
            上个月
          </button>
        ...
        <div className="grid grid-cols-7 gap-1 text-center">
          {['日', '一', '二', '三', '四', '五', '六'].map((day, index) => (
            <div key={index} className="text-white/60 font-semibold py-2">
              {day}
            </div>
          ))}
