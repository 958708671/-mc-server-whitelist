...
`;
  ...
  return (
    <div className="space-y-2">
      <div className="flex flex-wrap gap-1 p-2 rounded-lg" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.3)'}}>
      ...
      <textarea
        ...
        rows={10}
        className="w-full rounded-xl px-4 py-3 text-white focus:outline-none resize-none font-mono text-sm"
