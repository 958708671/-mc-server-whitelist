  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-white/60 text-sm mt-1">请所有管理员遵守以下守则</p>
      </div>
          ...
          <div className="space-y-3 text-white/80">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">审核时应保持客观，不偏不倚，不因个人喜好影响审核结果</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">收到新申请后应尽快处理，避免让玩家等待过长时间</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">仔细查看申请者的答题情况、作品和填写的信息，确保审核质量</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">拒绝申请时必须填写清晰的拒绝理由，方便申请者了解原因</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">只有在不确定审核结果或无法继续处理时，才可以将申请转给其他管理员</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3 text-white/80">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">不得泄露申请者的个人信息、联系方式等隐私内容</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">与玩家沟通时保持礼貌、专业，树立良好的管理员形象</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">管理员之间应互相配合，有问题及时沟通，共同维护服务器秩序</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">不得利用管理员权限谋取私利，或进行与管理无关的操作</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3 text-white/80">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">总分需达到60分及以上（满分100分）</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">选择建筑或生电领域的申请者，需提供1-10张作品截图，管理员应根据作品质量评估其能力</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">认真查看实景题回答，评估申请者的实际理解能力</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">查看申请者是否有被其他服务器封禁的记录，如有需谨慎评估</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">结合以上所有因素，做出最终的审核决定</p>
              </div>
            </div>
          </div>
        </div>
