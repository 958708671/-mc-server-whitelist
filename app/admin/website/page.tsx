    ...
    <div className="flex flex-col h-screen">
      <div className="p-4 flex justify-between items-center shrink-0" style={{backgroundColor: 'rgba(30, 40, 60, 0.8)', borderBottom: '1px solid rgba(93, 122, 156, 0.3)'}}>
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-green-600 rounded-lg flex items-center justify-center text-xl flex-shrink-0">
      ...
      {message && (
        <div className={`mx-4 mt-2 p-2 rounded-lg shrink-0 text-sm ${
          message.includes('成功')
        ...
        <div className="flex-1 h-full overflow-y-auto p-4">
          {activeSection === 'hero' && (
            <div className="space-y-6">
              ...
              <div className="rounded-xl p-6 space-y-4" style={{backgroundColor: 'rgba(30, 40, 60, 0.8)'}}>
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg px-4 py-3 text-white focus:outline-none" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full rounded-lg px-4 py-3 text-white focus:outline-none resize-none" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-xl p-6 space-y-4" style={{backgroundColor: 'rgba(30, 40, 60, 0.8)'}}>
                <div>
                  ...
                  <div className="w-full rounded-lg px-4 py-3 text-white" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
          ...
          {activeSection === 'features' && (
            <div className="space-y-6">
              ...
              {[1, 2, 3, 4].map(num => (
                <div key={num} className="rounded-xl p-6" style={{border: '1px solid rgba(30, 40, 60, 0.7)', backgroundColor: 'rgba(30, 40, 60, 0.8)'}}>
                      ...
                      <div className="grid grid-cols-5 gap-2">
                        {availableIcons.map(icon => (
                          ...
                          >
                            ...
                            />
                            <span className="text-xs text-white/70 truncate w-full text-center">{icon}</span>
                          </button>
                        ))}
                      </div>
                    </div>
