      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {admins.map((admin) => {
            ...
            return (
              <div key={admin.id} className="rounded-xl p-5" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
      ...
      <div className="rounded-xl overflow-hidden" style={{border: '1px solid rgba(30, 40, 60, 0.7)', backgroundColor: 'rgba(30, 40, 60, 0.8)'}}>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr>
                <th className="px-4 py-3 text-left text-white/60 text-sm font-medium">管理员</th>
                <th className="px-4 py-3 text-left text-white/60 text-sm font-medium">登录时间</th>
                <th className="px-4 py-3 text-left text-white/60 text-sm font-medium">IP地址</th>
                <th className="px-4 py-3 text-left text-white/60 text-sm font-medium">状态</th>
              </tr>
            </thead>
