  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-white/60 text-sm mt-1">配置服务器信息和系统功能</p>
      </div>
      ...
      <div className="flex gap-2 pb-2">
        <button
          ...
          className={`px-4 py-2 rounded-t-lg transition-colors ${
            activeTab === 'server' ? 'text-white' : 'text-white/60 hover:text-white'
          }`}
        ...
        <button
          ...
          className={`px-4 py-2 rounded-t-lg transition-colors ${
            activeTab === 'system' ? 'text-white' : 'text-white/60 hover:text-white'
          }`}
      ...
      {activeTab === 'server' && (
        <div className="space-y-6">
          {/* 白名单通知配置 */}
          <div className="rounded-xl p-6" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
            <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
              <span></span> 白名单通知配置
            </h2>
            <p className="text-white/60 text-sm mb-4">审核通过后发送给玩家的信息</p>
            
            <div className="space-y-4">
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">QQ群号</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">客户端下载地址</label>
                <input
                  type="text"
          ...
          <div className="rounded-xl p-6" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
            ...
            <p className="text-white/60 text-sm mb-4">用于自动添加白名单到Minecraft服务器</p>
            
            <div className="space-y-4">
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">RCON主机地址</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-white/80 text-sm mb-2 font-medium">RCON端口</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-white/80 text-sm mb-2 font-medium">RCON密码</label>
                  <input
                    type="password"
              ...
              {rconTestResult && (
                <div className="p-3 rounded-xl text-sm text-white" style={{border: '1px solid rgba(138, 158, 255, 0.9)', backgroundColor: 'rgba(138, 158, 255, 0.3)'}}>
                  {rconTestResult}
                </div>
              )}
            </div>
          ...
          <div className="rounded-xl p-6" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">服务器IP地址</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">服务器域名</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">服务器版本</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">Free Fabric版本</label>
                <input
                  type="text"
                  value={serverSettings.free_fabric_version}
                  readOnly
                  className="w-full rounded-xl px-4 py-3 text-white/60 focus:outline-none"
                  style={{border: '1px solid rgba(30, 40, 60, 0.7)', backgroundColor: 'rgba(30, 40, 60, 0.8)'}}
                />
          ...
          <div className="rounded-xl p-6" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">服务器MOTD</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">最大玩家数</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">视距</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">难度</label>
                <select
              ...
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">游戏模式</label>
                <select
      ...
      {activeTab === 'system' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="rounded-xl p-6" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">服务器名称</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">服务器描述</label>
                <textarea
          ...
          <div className="rounded-xl p-6" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">联系QQ</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-white/80 text-sm mb-2 font-medium">联系邮箱</label>
                <input
                  type="email"
          ...
          <div className="rounded-xl p-6 lg:col-span-2" style={{border: '1px solid rgba(93, 122, 156, 0.9)', backgroundColor: 'rgba(93, 122, 156, 0.8)'}}>
            <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
              <span></span> 功能开关
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex items-center justify-between p-4 rounded-xl" style={{border: '1px solid rgba(30, 40, 60, 0.7)', backgroundColor: 'rgba(30, 40, 60, 0.8)'}}>
                <div>
                  <p className="text-white font-medium">白名单系统</p>
                  <p className="text-white/60 text-sm">开启后只有白名单玩家可进入</p>
                </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-xl" style={{border: '1px solid rgba(30, 40, 60, 0.7)', backgroundColor: 'rgba(30, 40, 60, 0.8)'}}>
                <div>
                  ...
                  <p className="text-white/60 text-sm">允许玩家提交白名单申请</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
              ...
              <div className="flex items-center justify-between p-4 rounded-xl" style={{border: '1px solid rgba(30, 40, 60, 0.7)', backgroundColor: 'rgba(30, 40, 60, 0.8)'}}>
                <div>
                  ...
                  <p className="text-white/60 text-sm">开启后网站显示维护页面</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
      ...
      {message && (
        <div className="p-4 rounded-xl flex items-center gap-2 text-white" style={{border: '1px solid rgba(138, 158, 255, 0.9)', backgroundColor: 'rgba(138, 158, 255, 0.3)'}}>
          <span></span>
          {message}
        </div>
      )}
      ...
      <div className="flex justify-end gap-3">
        ...
        <button
          ...
          disabled={saving}
          className="px-6 py-3 text-white rounded-xl transition-all disabled:opacity-50 flex items-center gap-2"
          ...
          <div className="bg-black border border-white/20 rounded-xl p-6 max-w-md w-full mx-4">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 bg-white/20 hover:bg-white/30 text-white rounded-xl transition-colors"
              >
                确认安装
              </button>
            </div>
      ...
      {installingVersion && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-black border border-white/20 rounded-xl p-6 max-w-md w-full mx-4">
            ...
            <p className="text-white/80 mb-4">{installMessage}</p>
