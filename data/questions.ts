...
export const questionCategories: QuestionCategory[] = [
  {
    ...
    questions: [
      ...
      { id: 13, question: '窗户是建筑的重要组成部分。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 5, tag: '基础' },
      { id: 14, question: '建筑只需要实用，不需要美观。', options: ['正确', '错误'], correct: 1, type: 'judgment', score: 5, tag: '进阶' },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 25, question: '床可以跳过夜晚。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 3, tag: '基础' },
      { id: 26, question: '钻石是最稀有的矿物。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 3, tag: '基础' },
      { id: 27, question: '末影人会拿取方块。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 3, tag: '基础' },
      { id: 28, question: '村民可以交易。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 3, tag: '基础' },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 19, question: '以下哪些是常用指令？', options: ['/give', '/tp', '/gamemode', '/time'], correct: [0, 1, 2, 3], type: 'multiple', score: 5, tag: '基础' },
      { id: 20, question: '以下哪些指令可以更改游戏模式？', options: ['/gamemode creative', '/gamemode survival', '/gamemode adventure', '/gamemode spectator'], correct: [0, 1, 2, 3], type: 'multiple', score: 5, tag: '基础' },
      { id: 21, question: '以下哪些指令可以设置时间？', options: ['/time set day', '/time set night', '/time set noon', '/time set midnight'], correct: [0, 1, 2, 3], type: 'multiple', score: 5, tag: '基础' },
      { id: 22, question: '以下哪些指令可以设置天气？', options: ['/weather clear', '/weather rain', '/weather thunder', '/weather snow'], correct: [0, 1, 2], type: 'multiple', score: 5, tag: '进阶' },
      { id: 23, question: '指令需要在聊天框中输入。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 3, tag: '基础' },
      { id: 24, question: '指令前需要加斜杠。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 3, tag: '基础' },
      { id: 25, question: '所有服务器都可以使用指令。', options: ['正确', '错误'], correct: 1, type: 'judgment', score: 3, tag: '基础' },
      { id: 26, question: '命令方块可以执行指令。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 3, tag: '进阶' },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 13, question: '红石是Minecraft的重要组成部分。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 5, tag: '基础' },
      { id: 14, question: '生电很有趣。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 5, tag: '基础' },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 20, question: '以下哪些附魔适用于武器？', options: ['锋利', '击退', '火焰附加', '抢夺'], correct: [0, 1, 2, 3], type: 'multiple', score: 5, tag: '基础' },
      { id: 21, question: '以下哪些附魔适用于盔甲？', options: ['保护', '火焰保护', '爆炸保护', '弹射物保护'], correct: [0, 1, 2, 3], type: 'multiple', score: 5, tag: '进阶' },
      { id: 22, question: '以下哪些附魔适用于工具？', options: ['效率', '耐久', '精准采集', '时运'], correct: [0, 1, 2, 3], type: 'multiple', score: 5, tag: '基础' },
      { id: 23, question: '附魔台需要黑曜石和钻石制作。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 3, tag: '基础' },
      { id: 24, question: '书架可以增加附魔等级。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 3, tag: '基础' },
      { id: 25, question: '最高附魔等级是30级。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 3, tag: '基础' },
      { id: 26, question: '青金石是附魔的必需材料。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 3, tag: '基础' },
      { id: 27, question: '铁砧可以用来合并附魔。', options: ['正确', '错误'], correct: 0, type: 'judgment', score: 3, tag: '进阶' },
